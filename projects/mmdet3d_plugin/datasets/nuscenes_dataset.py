...
class CustomNuScenesDataset(NuScenesDataset):
    ...
    def __init__(self, queue_length=4, bev_size=(200, 200), overlap_test=False, *args, **kwargs):
        ...
        # textures = np.ones((1, num_faces, texture_size, texture_size, texture_size, 3), 'float32')
        ...
        if self.modality['use_camera']:
            ...
            for cam_type, cam_info in info['cams'].items():
                ...
                if not osp.isfile(cam_info['data_path']):
                    print(f"警告: 图像文件不存在 - {cam_info['data_path']}")
                ...
                # assign default value to intrinsic when it is missing
