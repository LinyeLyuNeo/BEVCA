...
def export_2d_annotation(root_path, info_path, version, mono3d=True):
    ...
    for info in mmcv.track_iter_progress(nusc_infos):
        for cam in camera_types:
            ...
            #     print(f"Warning: skipping non-camera sample_data_token {sample_data_token}")
            #     continue
...
def get_2d_boxes(nusc,
    ...
    # # Print the sensor modality for debugging purposes
    # print(f"Sensor Modality: {sd_rec['sensor_modality']}")
